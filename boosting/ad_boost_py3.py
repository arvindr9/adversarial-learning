...
class AdversarialBoost:
	...
	def fit(self, X, y):
		...
		for iboost in range(self.n_estimators):
			...
			print("Training time:", post_train - pre_train)
			self.training_time.append(post_train - pre_train)
			...
			self.boosting_time.append(t_boost_2 - t_boost_1)
	...
	def _advGen(self, estimator, n_adv, n_boost_random_train_samples, epsilon, X, y):
		...
		for image_no, image in enumerate(rand_X):
			...
			print("Adv-generation time", adv_end - adv_start)
...
if(__name__ == '__main__'):
	...
	print( "\n\n\n Printing the training time if file is not saved ")
	print(ab.estimator_errors_)
